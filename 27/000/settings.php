...
$tinyib_hidefieldsop = array('email', 'embed', 'password');       // Fields to hide when creating a new thread - e.g. array('name', 'email', 'subject', 'message', 'file', 'embed', 'password')
$tinyib_hidefields = array('email','subject','embed', 'password');         // Fields to hide when replying
...
define('TINYIB_THUMBNAIL', 'ffmpeg');     // Thumbnail method to use: gd / ffmpeg / imagemagick  (see README for instructions)
...
define('TINYIB_TRIPSEED', 'fj6s47gdog');        // Enter some random text  (used when generating secure tripcodes, hashing passwords and hashing IP addresses)
...
define('TINYIB_ADMINPASS', 'aaaa');       // Administrator password
define('TINYIB_MODPASS', 'mmmm');         // Moderator password  ['' to disable]
