 ...
 * common.php
 *
 * Shared functions for the board.
 *
 * Functions:
 *   - createThumbnail(): Creates a thumbnail from an image.
 *   - generatePagination(): Regenerates the static paginated main board pages.
 */

function createThumbnail(string $srcPath, string $dstPath, string $mime, int $maxSize): string {
...
function generatePagination(PDO $pdo, int $postsPerPage = 20): void {
...
<body>
  ...
  <form id="deleteform" action="post.php" method="post">
    ...
    <div class="userdelete" style="display:none;">
      Delete Post 
